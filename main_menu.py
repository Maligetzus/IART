...
class MainMenu:
    def __init__(self):
        ...
        self.player_types_arr = [PlayerTypes.Player, PlayerTypes.CpuGreedy, PlayerTypes.CpuL0, PlayerTypes.CpuL1, PlayerTypes.CpuL2, PlayerTypes.CpuL3, PlayerTypes.CpuRandom]
